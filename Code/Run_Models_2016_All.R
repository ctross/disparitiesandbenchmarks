...
m_weapons_nibrsa_2016 <- stan(file="Code/Shootings_Model.stan", data=model_dat, refresh=100, chains=nchains, iter=iter, warmup=warmup, 
 ...
 df_minor_ncvs_2016 <- data.frame(R=rstan::extract(m_minor_ncvs_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Minor",Source="NCVS")
 df_major_ncvs_2016 <- data.frame(R=rstan::extract(m_major_ncvs_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Major",Source="NCVS") 
 df_weapons_ncvs_2016 <- data.frame(R=rstan::extract(m_weapons_ncvs_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Weapons",Source="NCVS") 
                          
 df_minor_nibrs_2016 <- data.frame(R=rstan::extract(m_minor_nibrs_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Minor",Source="NIBRS")
 df_major_nibrs_2016 <- data.frame(R=rstan::extract(m_major_nibrs_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Major",Source="NIBRS") 
 df_weapons_nibrs_2016 <- data.frame(R=rstan::extract(m_weapons_nibrs_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Weapons",Source="NIBRS") 
 
 df_minor_nibrsa_2016 <- data.frame(R=rstan::extract(m_minor_nibrsa_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Minor",Source="NIBRS_Arrest")
 df_major_nibrsa_2016 <- data.frame(R=rstan::extract(m_major_nibrsa_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Major",Source="NIBRS_Arrest") 
 df_weapons_nibrsa_2016 <- data.frame(R=rstan::extract(m_weapons_nibrsa_2016,pars="R_PA"),Year=2016, Type="All Killings",Crime="Weapons",Source="NIBRS_Arrest")
                            
 df_2016_all <- rbind(df_minor_ncvs_2016,df_major_ncvs_2016,df_weapons_ncvs_2016,                         
   ...
   df_noneX_all_2016 <- data.frame(R=rstan::extract(m_weapons_ncvs_2016,pars="R_P"),Year=2016, Type="All Killings",Crime="None",Source="NA")
