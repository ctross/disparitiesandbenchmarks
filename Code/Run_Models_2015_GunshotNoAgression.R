...
######################### NCVS
model_dat <- list(
 B_S = d$Killed[which(d$Year==2015 & d$Type=="By gunshot, not agressing" & d$Race=="Black")],
 W_S = d$Killed[which(d$Year==2015 & d$Type=="By gunshot, not agressing" & d$Race=="White")],
...
m_weapons_nibrsa_2015 <- stan(file="Code/Shootings_Model.stan", data=model_dat, refresh=100, chains=nchains, iter=iter, warmup=warmup, 
 ...
 df_minor_ncvs_2015 <- data.frame(R=rstan::extract(m_minor_ncvs_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Minor",Source="NCVS")
 df_major_ncvs_2015 <- data.frame(R=rstan::extract(m_major_ncvs_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Major",Source="NCVS") 
 df_weapons_ncvs_2015 <- data.frame(R=rstan::extract(m_weapons_ncvs_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Weapons",Source="NCVS") 
                          
 df_minor_nibrs_2015 <- data.frame(R=rstan::extract(m_minor_nibrs_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Minor",Source="NIBRS")
 df_major_nibrs_2015 <- data.frame(R=rstan::extract(m_major_nibrs_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Major",Source="NIBRS") 
 df_weapons_nibrs_2015 <- data.frame(R=rstan::extract(m_weapons_nibrs_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Weapons",Source="NIBRS") 
 
 df_minor_nibrsa_2015 <- data.frame(R=rstan::extract(m_minor_nibrsa_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Minor",Source="NIBRS_Arrest")
 df_major_nibrsa_2015 <- data.frame(R=rstan::extract(m_major_nibrsa_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Major",Source="NIBRS_Arrest") 
 df_weapons_nibrsa_2015 <- data.frame(R=rstan::extract(m_weapons_nibrsa_2015,pars="R_PA"),Year=2015, Type="Not Agressing",Crime="Weapons",Source="NIBRS_Arrest")
 ...
 df_2015_noag <- rbind(df_minor_ncvs_2015,df_major_ncvs_2015,df_weapons_ncvs_2015,                         
   ...
   df_noneX_noag_2015 <- data.frame(R=rstan::extract(m_weapons_ncvs_2015,pars="R_P"),Year=2015, Type="Not Agressing",Crime="None",Source="NA")  
